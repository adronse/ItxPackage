...
class BugReportViewController: UIViewController {
    ...
    let screenRecordingButton = UIButton()
    let takeScreenshotButton = UIButton()
    let selectFileButton = UIButton()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        // Configure the UI elements here
        setupUI()
    }
    ...
    func setupUI() {
        ...
        screenRecordingButton.setTitle("Start a screen recording", for: .normal)
        screenRecordingButton.backgroundColor = .blue
        view.addSubview(screenRecordingButton)
        
        screenRecordingButton.snp.makeConstraints { make in
        ...
        takeScreenshotButton.setTitle("Take a screenshot", for: .normal)
        takeScreenshotButton.backgroundColor = .green
        view.addSubview(takeScreenshotButton)
        
        takeScreenshotButton.snp.makeConstraints { make in
            make.top.equalTo(screenRecordingButton.snp.bottom).offset(20)
            make.left.right.equalTo(screenRecordingButton)
            make.height.equalTo(44)
        }
        
        // Select File Button
        selectFileButton.setTitle("Select file from gallery", for: .normal)
        selectFileButton.backgroundColor = .red
        view.addSubview(selectFileButton)
        
        selectFileButton.snp.makeConstraints { make in
            make.top.equalTo(takeScreenshotButton.snp.bottom).offset(20)
            make.left.right.equalTo(takeScreenshotButton)
            make.height.equalTo(44)
        }
    }
}
